...
import type { BannersServices, BannersServicesId } from './banners-services';
...
export class PageServices extends Model<PageServicesAttributes, PageServicesCreationAttributes> implements PageServicesAttributes {
  ...
  // PageServices hasMany BannersServices via IdPageService
  BannersServices!: BannersServices[];
  getBannersServices!: Sequelize.HasManyGetAssociationsMixin<BannersServices>;
  setBannersServices!: Sequelize.HasManySetAssociationsMixin<BannersServices, BannersServicesId>;
  addBannersService!: Sequelize.HasManyAddAssociationMixin<BannersServices, BannersServicesId>;
  addBannersServices!: Sequelize.HasManyAddAssociationsMixin<BannersServices, BannersServicesId>;
  createBannersService!: Sequelize.HasManyCreateAssociationMixin<BannersServices>;
  removeBannersService!: Sequelize.HasManyRemoveAssociationMixin<BannersServices, BannersServicesId>;
  removeBannersServices!: Sequelize.HasManyRemoveAssociationsMixin<BannersServices, BannersServicesId>;
  hasBannersService!: Sequelize.HasManyHasAssociationMixin<BannersServices, BannersServicesId>;
  hasBannersServices!: Sequelize.HasManyHasAssociationsMixin<BannersServices, BannersServicesId>;
  countBannersServices!: Sequelize.HasManyCountAssociationsMixin;
