...
export const newDevice = (param:Params):string =>  `
    <tr>
        <td>
                ...
                <tr>
                    <td>
                        <table align='left' border='0' cellpadding='0' cellspacing='0' style='width: 100%; margin: 15px 0px; line-height: 22px; font-size: 12px; text-align: justify;'>  
                            <tr><td>El código de verificación de ${param.company} es: <strong style='letter-spacing: 2pt; font-size: 15px;'>${param.code}</strong></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
